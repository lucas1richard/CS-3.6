...
(function() {
  overlay
    .set("formatViewComponentRecord", formatViewComponentRecord);
    ...
    chrome.storage.sync.get({userInfo:false}, function(item) {
      ...
      var staffSelect = (function() {
        ...
        staffSelect.addEventListener("change", function() {
          ...
          if(staffSelect.value == "ContactTPM") window.open(generateEmailHref());
      ...
      function generateEmailHref() {
        ...
        function checkForIssues(str) {
           if (str.toLowerCase().search("tbd") != -1 || str.toLowerCase().search("to be decided") != -1 || str.toLowerCase().search("to be entered") != -1 || str.toLowerCase().search("none") != -1) {
            return true;
