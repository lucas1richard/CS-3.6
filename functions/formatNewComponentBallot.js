function formatNewComponentBallot() {
	...
	var trackingnumberselect = document.getElementById("TrackingNumber");
	for(var i=0; i<trackingnumberselect.children.length; i++) {
		if(i % 2) {
			var cls = "btn btn-default btn-xs center-block";
		} else {
			var cls = "btn btn-default active btn-xs center-block";
		}
			trackingnumberselect.children[i].className = cls;
	}
	...
	chrome.storage.local.get({
		...
		var componentballot = (function(records) {
			...
			var populateComponentDescription = function() {
